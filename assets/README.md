...
1. Upload Metadata files to IPfFS
...
### Generate a tokenIndicesview image

Create a tokenIndicesview image collage of your collection, run:

```sh
npm run tokenIndicesview
```
